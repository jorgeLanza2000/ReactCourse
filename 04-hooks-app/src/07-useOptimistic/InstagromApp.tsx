...
export const InstagromApp = () => {
  ...
  const handleAddComment = async (formData: FormData) => {
    ...
    startTransition(async () => {
      ...
      //! este sería el codigo para peticion exitosa
      //   setComments((prev) => [
      //     ...prev,
      //     {
      //       id: new Date().getTime(),
      ...
      //! este sería el codigo para revertir el proceso
  ...
  return (
    <div className='bg-slate-700 h-screen flex flex-col items-center justify-center'>
      ...
      <form
        // action={(event) => handleAddComment(event)} tambien se puede de esta forma
